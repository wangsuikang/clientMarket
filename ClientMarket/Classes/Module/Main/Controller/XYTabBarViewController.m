...
- (void)viewDidLoad {
    ...
    [self createChildVCWithVC:discover Title:@"分类" Image:@"mycity_normal" SelectedImage:@"mycity_highlight"];
    
    XYNoticeTableViewController *message = [[XYNoticeTableViewController alloc] init];
    [self createChildVCWithVC:message Title:@"一起逛" Image:@"message_normal" SelectedImage:@"message_highlight"];
    
    XYMineViewController *profile = [[XYMineViewController alloc] init];
