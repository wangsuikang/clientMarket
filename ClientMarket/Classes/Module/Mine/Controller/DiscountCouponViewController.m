...
- (void)viewDidLoad {
    ...
    [button addTarget:self action:@selector(moreDiscountCouponBtnClick) forControlEvents:UIControlEventTouchUpInside];
...
#pragma mark -更多优惠券
- (void)moreDiscountCouponBtnClick {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[[NSBundle mainBundle]loadNibNamed:@"DiscountCouponCell" owner:self options:nil]lastObject];
